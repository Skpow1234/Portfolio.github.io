export const es = {
  ...
  contact: {
    ...
    heading: 'Conectemos',
    intro:
      'Siempre estoy abierto a discutir nuevos proyectos, ideas creativas u oportunidades para ser parte de tus visiones. Contáctame por LinkedIn o mira mi trabajo en GitHub.',
